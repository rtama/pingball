...
public class Ball extends Gadget {
    ...
    public void drawCanvas(Graphics2D g2d) {
        ...
        Shape shape = new Ellipse2D.Double( (this.xPos + 1 - this.RADIUS*scaleFactor)*scaleFactor, (this.yPos + 1- this.RADIUS*scaleFactor)*scaleFactor, 2*this.RADIUS*scaleFactor,2*this.RADIUS*scaleFactor);
